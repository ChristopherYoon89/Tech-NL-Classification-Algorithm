...
data = pd.read_excel('KrakenNewsLanguageTrainingData.xlsx')
...
def train(X, y, hidden_neurons=10, alpha=1, epochs=50000, dropout=False, dropout_percent=0.5):
    ...
    for j in iter(range(epochs+1)):
        ...
        layer_2 = relu_activate(np.dot(layer_1, synapse_1))
        ...
        layer_2_delta = layer_2_error * relu_output_to_derivative(layer_2)
    ...
    synapse_file = "Onlineshop/synapses_language_2classes_v2.json"

    with open(synapse_file, 'w', encoding='utf8') as outfile:
